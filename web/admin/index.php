...
<body>
	...
	<div id='page' data-bind="template: { name: pageToDisplay, data: $data}">
	</div>
		...
		<table>
		    ...
		    <tbody data-bind="foreach: users">
		        <tr>
		            ...
		            <td>
		            	<a data-bind="click: $root.openEditUser.bind(this, $root)">Edit</span>
		            </td>
		        </tr>
		    </tbody>
		</table>
...
<script>
	...
	var adminPageViewModel = {
		blankAdministrator : <?php echo $blankAdministrator  ?>,
		...
		currentPage : ko.observable('blank'),
		users : ko.observableArray(),
		userToEdit : ko.observable(),
		pageToDisplay: function(model) {
		...
		openEditUser: function(root, user) {
			// debugger;
